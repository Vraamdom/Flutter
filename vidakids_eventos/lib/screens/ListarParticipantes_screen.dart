...
Future<List<Participante>> fetchPost() async {
  final response = await http.get(
      Uri.parse("https://eventosapiflutter.onrender.com/participantes"));
  if (response.statusCode == 200) {
    final jsonData = json.decode(response.body) as Map<String, dynamic>;
    final List<dynamic> participantesJson = jsonData['msg'];
    return participantesJson.map((json) => Participante.fromJson(json)).toList();
  } else {
...
class _ListarParticipantesState extends State<ListarParticipantes> {
 ...
 void editarParticipante(BuildContext context, Participante participante) async {
              ...
              return ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text(participantes[index].Placa_vehiculo_personal.toString()),
